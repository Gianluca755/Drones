...
Intuition suggests that the "Echo" uses less messages.
We utilized the simplify assumption that the channels offer a reliable delivery of the data packets. This isn't an unrealistic assumption since we can imagine to transfer single data packet over a TCP connection.
