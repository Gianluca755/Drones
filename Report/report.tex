...
\author{Ermacora Gianluca \\ Rovere Andrea 128074}
...
\begin{itemize}
	\item con\textbf{currency transparency}: only one drone will be selected to carry out the delivery of a package, but multiple orders from multiple clients are handled concurrently;
