...
The space is modelled by a 2D grid, so the diagonal movements of drones are calculated with some approximation. There aren't forbidden zone nor forced paths.\\
...
There is an other server for the registration of the drones, this server also introduces a new drone to a few other.
