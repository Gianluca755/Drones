...
\item \textbf{"delivered"}:and order is in this state after the package has been delivered to it's destination and the management server recieves the "delivered" message form the drone;
\end{itemize}
