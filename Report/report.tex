...
We utilized the simplify assumption that the channels offer a reliable delivery of the data packets. This isn't an unrealistic assumption since we can imagine to transfer data packets (UDP) over an overlay TCP network.
